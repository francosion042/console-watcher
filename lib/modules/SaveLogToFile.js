...
var SaveLogToFile = /** @class */ (function () {
    function SaveLogToFile() {
    }
    SaveLogToFile.prototype.appendToNonJSONFile = function (filePath, obj) {
        var logData = JSON.stringify(obj);
        fs.appendFileSync(filePath, logData + '\n');
    };
    // Append an object to the target JSON file.
    SaveLogToFile.prototype.appendToJSONFile = function (filePath, obj) {
        var fileContent;
...
exports.default = new SaveLogToFile();
